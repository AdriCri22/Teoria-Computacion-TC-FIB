# DFA (Deterministic Finite Automaton) - DFA (Autómatas Finitos Deterministas)
...
### Image solution:
![Solution](https://github.com/AdriCri22/Teoria-Computacion-TC-FIB/blob/main/DFA/Image_solutions/Image_sol_17.png)
